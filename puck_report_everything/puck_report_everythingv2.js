// this code was pulled off the espruino, but it's not the same as what I uploaed to it.
// so saving this in case the actual code is lost...


var INSTANCE_ID = null;
var ACC_SAMPLE_RATE_HZ = 12.5;
var LED_BLINK_MILLISECONDS = 50;
var POLL_QUEUE_MIILISECONDS = 50;
var INVALID_ACCELERATION_CODE = 32;
var MAX_ACCELERATION_TO_ENCODE = 2;
var MAX_ACCELERATION_MAGNITUDE = 31;
var ACCELERATION_UNITS_PER_G = 8192;
var ENABLE_ACCELEROMETER = true;
var MAX_BATTERY_VOLTAGE = 3;
var MIN_BATTERY_VOLTAGE = 2;
var DIRACT_PROXIMITY_FRAME = 1;
var DIRACT_DIGEST_FRAME = 17;
var DIRACT_DEFAULT_COUNT_LENGTH = 7;
var DIRACT_MANUFACTURER_ID = 1411;
var DIRACT_INSTANCE_LENGTH = 4;
var DIRACT_INSTANCE_OFFSET = 2;
var BITS_PER_BYTE = 8;
var EDDYSTONE_INSTANCE_OFFSET = 14;
var queue = false;

var accelPackage = false;
var accelPollMS = 100;
var accelDuration = 500;
var accelScaleX = Object.create(accelScaleX.__proto__.constructor["prototype"]);
accelScaleX.inmin = false;
accelScaleX.inmax = false;
accelScaleX.outmin = 0;
accelScaleX.outmax = 1;
var accelScaleY = Object.create(accelScaleX.__proto__);
accelScaleY.inmin = false;
accelScaleY.inmax = false;
accelScaleY.outmin = 0;
accelScaleY.outmax = 1;
var accelScaleZ = Object.create(accelScaleX.__proto__);
accelScaleZ.inmin = false;
accelScaleZ.inmax = false;
accelScaleZ.outmin = 0;
accelScaleZ.outmax = 1;
...
var instanceId = new Uint8Array([0, 0, 20, 6]);
...
BLEQueue.prototype.addToQueue = function (id,priority,interval,ifDupeFound,getDataCallback,setAdvertisingCallback) {
  let time = new Date();
...
BLEQueue.prototype.pollQueue = function () {
...
BLEQueue.prototype.broadcast = function (item,interval) {
  this.endBroadcast();
...
BLEQueue.prototype.endBroadcast = function () {
  clearTimeout(this.timeoutID);
        this.currentBroadcastItem = false;
        this.timeoutID = false;
};
BLEQueue.prototype.getNextQueueItem = function () {
...
function dynScale(inmin,inmax,outmin,outmax) {
  this.inmin = inmin;
    this.inmax = inmax;
    this.outmin = outmin;
    this.outmax = outmax;
}
dynScale.prototype.scale = function (value) {
...
Puck.on("accel", handleAcceleration);
var encodedAcceleration = accelPackage;
setInterval(function () {
  queue.pollQueue(), 
    POLL_QUEUE_MIILISECONDS
}, 0.09918212890); // 2
setInterval(sendAcceleration, 99.99942779541); // 3
setTimeout(function () {self.endBroadcast();}, 11.74926757812); // 4
digitalWrite(D27, 0);
NRF.setAdvertising(new Uint8Array([2, 1, 6, 12, 255, 131, 5, 1, 7, 0, 0, 20, 6, 0, 3, 244]).buffer, { "interval": 500, "showName": false, "manufacturer": 1411, 
  "manufacturerData": [ 1, 7, 0, 0, 20, 6, 0, 3, 244 ]
 });
